...
public class AlipayConfig {
    ...
    //http://vf6ipy.natappfree.cc
    // 服务器异步通知页面路径 需http://或者https://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
    public static String NOTIFY_URL = "http://www.zkingedu.xyz:8899";
    //public static String NOTIFY_URL = "http://ksvbuw.natappfree.cc";
    //跳转页面，买家支付成功后跳转的页面
    public static String RETURN_URL = "http://www.zkingedu.xyz:8899/user/userinfo/index#get8";
    // RSA2
