...
public interface PostService {
    ...
    PageInfo<Map<String, Object>> getAllpstByUId(Integer page, Integer pageSize, Integer uid);
    ...
    PageInfo<Map<String, Object>> hqhtpost(Integer page, Integer pageSize, String puname, String pname, String pcname);
