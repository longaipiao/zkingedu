(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery","simple-module","simple-hotkeys","simple-uploader","static/user/scripts/dompurify"], function ($, SimpleModule, simpleHotkeys, simpleUploader, DOMPurify) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("simple-uploader"),require("static/user/scripts/dompurify"));
  } else {
